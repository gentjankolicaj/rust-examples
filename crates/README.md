...
- If some_file.rs has mod declarations in it, then the contents of the module files would be inserted in places where
  mod declarations in the crate file are found, before running the compiler over it.
...
- This behavior can be overridden by passing the --crate-type flag to lib.Ex: rustc --crate-type=lib some_file.rs