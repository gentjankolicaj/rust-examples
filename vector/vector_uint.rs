...
fn main() {
    println!("unsigned integer values in vectors: ");
    let v8: Vec<u8> = vec![1, 2, 3];
    let v16: Vec<u16> = vec![1u16, 2, 3];
    let v32: Vec<u32> = vec![1u32, 2, 3];
    let v64: Vec<u64> = vec![1u64, 2, 3];
    let v128: Vec<u128> = vec![1u128, 2, 3];
